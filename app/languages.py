...
LANGUAGE_FONT_MAP = {
    "zh-CN": "NotoSansTC-Regular.ttf",  # Chinese (Simplified)
    "zh-TW": "NotoSansSC-Regular.ttf",  # Chinese (Traditional)
    "ja": "NotoSansJP-Regular.ttf",     # Japanese
    "ko": "NotoSansKR-Regular.ttf",     # Korean
    "ar": "NotoSansArabic-Regular.ttf",  # Arabic, Persian, Urdu
    "hi": "NotoSansDevanagari-Regular.ttf",  # Hindi, Marathi, Nepali
    "bn": "NotoSansBengali-Regular.ttf",  # Bengali, Assamese
    "th": "NotoSansThai-Regular.ttf",  # Thai, Lao
    "default": "NotoSans-Regular.ttf",  # Everything else (English, Spanish, etc.)
}